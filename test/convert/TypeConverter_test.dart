...
void main() {
  group('TypeConverter', () {
    test('To Type Code', () {
      ...
      expect(TypeConverter.toTypeCode(new DateTime(1975, 4, 8)),
          equals(TypeCode.DateTime));
      expect(
          TypeConverter.toTypeCode(new Duration()), equals(TypeCode.Duration));
    ...
    test('To Type With Default', () {
      ...
      expect(
          TypeConverter.toTypeWithDefault<Duration>(
              TypeCode.Duration, null, new Duration(milliseconds: 123)),
          equals(new Duration(milliseconds: 123)));
      expect(
