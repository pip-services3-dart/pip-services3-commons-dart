...
void main() {
  group('DoubleConverter', () {
      ...
      test('To Double', () {
          ...
          expect(DoubleConverter.toDouble('123.456'), equals(123.456));
          expect(DoubleConverter.toDouble(new DateTime.fromMillisecondsSinceEpoch(123)), equals(123));
          expect(DoubleConverter.toDouble(new Duration(milliseconds: 123)), equals(123));
