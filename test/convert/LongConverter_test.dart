...
void main() {
  group('LongConverter', () {
      ...
      test('To Long', () {
          ...
          expect(LongConverter.toLong('123'), equals(123));
          expect(LongConverter.toLong(new DateTime.fromMillisecondsSinceEpoch(123)), equals(123));
          expect(LongConverter.toLong(new Duration(milliseconds: 123)), equals(123));
