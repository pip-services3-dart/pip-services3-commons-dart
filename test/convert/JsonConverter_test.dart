...
void main() {
  group('JsonConverter', () {
      ...
      test('From Json', () {
          ...
          expect(JsonConverter.fromJson<String>(TypeCode.String, "\"ABC\""), equals("ABC"));
              
          var filter = JsonConverter.fromJson(null, "{\"Key2\":\"ABC\",\"Key1\":\"123\"}");
          expect(filter, isMap);
          ...
          var date = DateTimeConverter.toDateTime("1975-04-08T00:00:00.000Z");
          var jsonDate = JsonConverter.fromJson<DateTime>(TypeCode.DateTime, "\"1975-04-08T00:00Z\"");
