...
class ObjectSchema extends Schema {
     ...
     * @see [[IValidationRule]]
     */
    ObjectSchema([bool allowUndefined, bool req, List<IValidationRule> rules]):super(req, rules) {
    ...
    withProperty(PropertySchema schema )  {
        this._properties = this._properties != null ? this._properties : List<dynamic>();
