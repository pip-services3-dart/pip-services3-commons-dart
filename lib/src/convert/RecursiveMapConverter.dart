...
class RecursiveMapConverter {
    ...
    static _isPrimitive(value) {
        ...
        else if (value is num) return true;
        else if (value is DateTime) return true;
        else if (value is Duration) return true;
        else if (value is String) return true;
    ...
    static _valueToMap(value) {
        ...
        if (value is Map)
            return _mapToMap(value);

        // Convert arrays
        if (value is List)
            return _arrayToMap(value);
