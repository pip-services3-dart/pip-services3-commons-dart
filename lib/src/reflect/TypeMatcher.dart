...
class TypeMatcher {
    ...
    static bool matchValueType(expectedType, actualValue) {
        if (expectedType == null)
            return true;
        if (actualValue == null)
        	throw new Exception("Actual value cannot be null");
     ...
     */
    static bool matchType(expectedType, TypeCode actualType, [ actualValue = null ]) {
        if (expectedType == null)
            return true;
        if (actualType == null)
        	throw new Exception("Actual type cannot be null");
     ...
     * @returns true if types are matching and false if they don't.
     */
    static bool matchTypeByName(String expectedType, TypeCode actualType, [actualValue = null]) {
        if (expectedType == null)
        	return true;
        if (actualType == null)
        	throw new Exception("Actual type cannot be null");
